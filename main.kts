...
val mapFoldResults = (0..15).map{i->mapOf(i%3 to "FIZZ",i%5 to "BUZZ", i%15 to "FIZZBUZZ", i to null)[0]}.filter{it != null}.fold(""){mapFoldResults,next->mapFoldResults+next}
